...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-graph-025-degree-diameter-problem-4dad3f1e-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GRAPH-025"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-graph-025-degree-diameter-problem-4dad3f1e-v1",
      "problem_contract_sha256": "54e3c9c59703273b7aa7413fa3473a5a4be41d44da6f462d6432a9da17cadb45",
      "problem_id": "problem:um-graph-025-degree-diameter-problem-4dad3f1e",
      "route_id": "route:um-graph-025-degree-diameter-problem-4dad3f1e-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-graph-025-degree-diameter-problem-4dad3f1e-source-fidelity-01",
      "graph_id": "graph:um-graph-025-degree-diameter-problem-4dad3f1e-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-graph-025-degree-diameter-problem-4dad3f1e-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-graph-025-degree-diameter-problem-4dad3f1e-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "For given maximum degree d and diameter k, what is the largest possible number of vertices in a graph?"
          },
          "statement_sha256": "d13311f7827e5a440c53ba2ba73003a7980a5994d24466784749428e234c2405"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-graph-025-degree-diameter-problem-4dad3f1e-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-graph-025-degree-diameter-problem-4dad3f1e-root",
      "route_id": "route:um-graph-025-degree-diameter-problem-4dad3f1e-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-graph-025-a8dd4c9f8c9b",
        "url": "https://www.unsolvedmath.com/problems/GRAPH-025"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
